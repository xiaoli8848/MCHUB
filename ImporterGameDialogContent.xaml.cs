...
namespace MCHUB
{
    ...
    /// </summary>
    public sealed partial class ImporterGameDialogContent : Page
    {
        public ImporterGameDialogContent()
        {
    ...
    public sealed class ImporterGameDialog : ContentDialog
    {
        public ImporterGameDialog(XamlRoot root) : base()
        {
            ...
            this.Content = new ImporterGameDialogContent();
            ...
            (this.Content as ImporterGameDialogContent).PickerButton.Click += async (sender, arg) => 
            {
                ...
                (this.Content as ImporterGameDialogContent).PathBox.Text = folder.Path;
